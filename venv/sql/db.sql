...
CREATE TABLE `APP_INFO` (
  ...
  `VOLUME_TYPE` varchar(45) DEFAULT NULL,
...
CREATE TABLE `CMDB_APP_VOLUME_TYPE` (
  `WRITE_TIME` datetime NOT NULL,
  `SYSTEMCODE` varchar(64) DEFAULT NULL,
  `APP_NAME` varchar(64) DEFAULT NULL,
  `VOLUME_TYPE` varchar(64) DEFAULT "STEADY"
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `UMP_STD_CONF` (
...
CREATE TABLE `UMP_EVAL_RESULT` (
  `WRITE_TIME` datetime NOT NULL,
  `STD_NAME` varchar(128) DEFAULT NULL,
  `APP_NAME` varchar(64) DEFAULT NULL,
  `MO_TYPE` varchar(128) DEFAULT NULL,
  `KEYWORD` varchar(128) DEFAULT NULL,
  `IP_ADDRESS` varchar(64) DEFAULT NULL,
  `STD_POLICY_COUNT` int(11) DEFAULT '0',
  `REAL_STD_POLICY_COUNT` int(11) DEFAULT '0',
  `CUSTOM_POLICY_COUNT` int(11) DEFAULT NULL,
  `STD_POLICY_PCT` int(11) DEFAULT NULL,
  `STD_DELTA_LIST` text,
  `CUSTOM_POLICY_LIST` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
